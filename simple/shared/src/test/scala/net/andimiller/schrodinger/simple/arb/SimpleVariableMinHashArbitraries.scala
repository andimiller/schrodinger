...
import net.andimiller.schrodinger.simple.SimpleVariableMinHash
import org.scalacheck.Arbitrary
import org.scalacheck.Gen

trait SimpleVariableMinHashArbitraries {

  implicit def simpleMinHashArb[
      HashCount <: Int: ValueOf,
      HashWidth <: Int: ValueOf
  ]: Arbitrary[SimpleVariableMinHash[HashCount, HashWidth]] = {
    ...
    Arbitrary(
      Gen
        ...
        .map(
          SimpleVariableMinHash.fromItems[HashCount, HashWidth, String, Int](_)
        )
    )
  }
