...
import net.andimiller.schrodinger.hash4j.HyperLogLogInstances
import org.scalacheck.Arbitrary
import org.scalacheck.Gen

trait HyperLogLogArbitraries extends HyperLogLogInstances {

  implicit def simpleHLLArb(implicit
      p: HyperLogLogP
  ): Arbitrary[HyperLogLog] = {
